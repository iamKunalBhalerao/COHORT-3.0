    ...
    <>
      <div className="w-full h-screen flex items-center justify-center bg-slate-950">
        <div className="w-lg px-4 py-3 flex flex-col itesm-center justify-center bg-slate-900 rounded-lg border-1 border-slate-500">
          ...
          {error && (
            <div className="py-2 px-4 rounded-lg my-2 flex itemscenter justify-center bg-slate-900 border-1 border-slate-500">
              <p className="text-red-700 text-xl">Invalid user credentials!</p>
            </div>
          )}
          <p className="py-4">
